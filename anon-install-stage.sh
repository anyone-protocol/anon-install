...
sudo echo "deb [signed-by=/etc/apt/trusted.gpg.d/anon.asc] https://deb.en.anyone.tech anon-stage-$VERSION_CODENAME main" | sudo tee /etc/apt/sources.list.d/anon.list
